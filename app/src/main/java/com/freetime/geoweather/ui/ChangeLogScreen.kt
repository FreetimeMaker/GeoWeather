...
fun ChangeLogScreen(onBack: () -> Unit) {
    val releases = listOf(
        "v4.7.1" to listOf(
            ...
            stringResource(Res.string.cl_471_share),
            stringResource(Res.string.cl_471_alerts),
            stringResource(Res.string.cl_471_notifications),
            stringResource(Res.string.cl_471_performance)
        ),
        "v4.7.0" to listOf(
            stringResource(Res.string.cl_470_intelligence),
            stringResource(Res.string.cl_470_models),
            stringResource(Res.string.cl_470_radar),
            stringResource(Res.string.cl_470_offline),
            stringResource(Res.string.cl_470_travel),
            stringResource(Res.string.cl_470_search),
            stringResource(Res.string.cl_470_notifications),
            stringResource(Res.string.cl_470_performance)
        ),
        "v4.6.5" to listOf(
            stringResource(Res.string.cl_465_core_110),
        ...
        "v4.6.4" to listOf(
            ...
            stringResource(Res.string.cl_464_adaptive),
            stringResource(Res.string.cl_464_components),
            stringResource(Res.string.cl_464_modules),
            stringResource(Res.string.cl_464_details),
            stringResource(Res.string.cl_464_material),
            stringResource(Res.string.cl_464_widgets),
            stringResource(Res.string.cl_464_fixes)
        ),
        "v4.6.3" to listOf(
            stringResource(Res.string.cl_463_core),
            stringResource(Res.string.cl_463_packages),
            stringResource(Res.string.cl_463_design),
            stringResource(Res.string.cl_463_states),
            stringResource(Res.string.cl_463_motion),
            stringResource(Res.string.cl_463_diagnostics),
            stringResource(Res.string.cl_463_fixes)
        ),
        "v4.6.2" to listOf(
        ...
        "v4.6.1" to listOf(
            ...
            stringResource(Res.string.cl_461_icons),
            stringResource(Res.string.cl_461_main_scroll),
            stringResource(Res.string.cl_461_layout),
            stringResource(Res.string.cl_461_fixes)
        ),
        "v4.6.0" to listOf(
            stringResource(Res.string.cl_460_smart),
            stringResource(Res.string.cl_460_timeline),
            stringResource(Res.string.cl_460_sun),
            stringResource(Res.string.cl_460_conditions),
            stringResource(Res.string.cl_460_history),
            stringResource(Res.string.cl_460_indicators),
            stringResource(Res.string.cl_460_locations),
            stringResource(Res.string.cl_460_widgets),
            stringResource(Res.string.cl_460_landscape),
            stringResource(Res.string.cl_460_glass_details),
            stringResource(Res.string.cl_460_diagnostics),
            stringResource(Res.string.cl_460_fixes)
        ),
        "v4.5.0" to listOf(
            stringResource(Res.string.cl_450_redesign),
            stringResource(Res.string.cl_450_navigation),
            stringResource(Res.string.cl_450_components),
            stringResource(Res.string.cl_450_add_location),
            stringResource(Res.string.cl_450_search),
            stringResource(Res.string.cl_450_time_picker),
            stringResource(Res.string.cl_450_contrast),
            stringResource(Res.string.cl_450_consistency),
            stringResource(Res.string.cl_450_fixes)
        ),
        "v4.4.2" to listOf(
            stringResource(Res.string.cl_442_glass),
            stringResource(Res.string.cl_442_components),
            stringResource(Res.string.cl_442_performance),
            stringResource(Res.string.cl_442_compare),
            stringResource(Res.string.cl_442_dependencies),
            stringResource(Res.string.cl_442_fixes)
        ),
        "v4.4.1" to listOf(
