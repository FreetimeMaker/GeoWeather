...
fun ChangeLogScreen(onBack: () -> Unit) {
    val releases = listOf(
        ...
        "v1.3.5" to listOf(
            "${stringResource(R.string.added_label)} ${stringResource(R.string.cl_v135_added_dons)}",
            "${stringResource(R.string.fixed_label)} ${stringResource(R.string.cl_v135_fixed_system_theme)}"
        ),
        "v1.3.4" to listOf(
