...
/**
 * Registers crypto providers that are not covered by
 * [FreetimePay.registerDefaultCryptoProviders].
 * EVM-based chains (BNB, ARB, OP, BASE) reuse the "ethereum" URI scheme
 * since their addresses are identical to Ethereum addresses.
 */
